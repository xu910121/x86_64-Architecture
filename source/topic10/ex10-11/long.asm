...
;        call lib32_service
        ...
        mov esi, msg1
        mov eax, LIB32_PUTS
        call sys_service_enter                             ; 64-bit 模式的 sys_service() stub 函数
...
msg1        db '---> Now: call sys_service() from 64-bit mode with sysenter instruction', 10, 0
